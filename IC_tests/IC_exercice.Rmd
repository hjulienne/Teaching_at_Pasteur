...
## Illustration - Effect of the sample size on the Confidence interval size
...
cat(paste("95% confidence interval = [",round(ICinf.week1,2),";",round(ICsup.week1,2),"]"))
cat(paste("mean",mean.week1,"95% confidence interval = [",round(ICinf.week12,2),";",round(ICsup.week12,2),"]"))
